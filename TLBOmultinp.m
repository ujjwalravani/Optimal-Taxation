function [end_gini,bestsol,bestfitness,BestFitIter,P,f] = TLBOmultinp(prob,lb,ub,Np,T,rev)
...
for t = 1: T
    ...
    for i = 1:Np
        ...
        [fnew,~] = prob(Xnew,rev);          % Evaluating the fitness of the newly generated solution
