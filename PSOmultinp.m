function [end_gini_pso,bestsol,bestfitness,BestFitIter,P,f] = PSOmultinp(prob,lb,ub,Np,T,w,c1,c2,rev)
...
for t = 1:T
    ...
    for p = 1:Np
        ...
        [f(p),~] = prob(P(p,:),rev);        % Determining the fitness of the new solution
