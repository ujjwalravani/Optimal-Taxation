function [end_gini_de,bestsol,bestfitness,BestFitIter,P,f] = DifferentialEvolutionmultinp(prob,lb,ub,Np,T,Pc,F,rev)
...
for t = 1: T
    ...
    for j = 1:Np
        ...
        [fu(j),~] = prob(U(j,:),rev);                   % Evaluating the fitness of the trial solution
